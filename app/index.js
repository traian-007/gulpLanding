let title = document.querySelector(".header__assessments-disciplines-text-title");
...
const img = document.querySelectorAll(".header__smilik-group");
function eyeball(evt) {
  let x = img[0].getBoundingClientRect().left + img[0].clientWidth / 1.9;
  let y = img[0].getBoundingClientRect().top + img[0].clientHeight / 1.9;
...
window.addEventListener("scroll", function () {
  ...
  const parallax2 = document.querySelector(".table__developer-quiz");
  const parallax3 = document.querySelector(".table__hiring");
  const parallax4 = document.querySelector(".table__question");
  const parallax5 = document.querySelector(".header__btn");
  const parallax6 = document.querySelector(".header__assessments-disciplines");
  const parallax7 = document.querySelector(".header__assessments");
  let scrollPosition = window.pageYOffset;
  parallax1.style.transform = "translateY(" + scrollPosition * -0.3 + "px)";
  parallax2.style.transform = "translateY(" + scrollPosition * -0.3 + "px)";
  parallax3.style.transform = "translateY(" + scrollPosition * -0.3 + "px)";
  parallax4.style.transform = "translateY(" + scrollPosition * -0.3 + "px)";
  ...
  } else if (parallax5.getBoundingClientRect().top == parallax6.getBoundingClientRect().top) {
...
const email = document.querySelector(".footer__second__email");
